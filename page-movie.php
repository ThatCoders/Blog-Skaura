...
get_header(); ?>
    ...
    <link href="https://whitecode.oss-cn-qingdao.aliyuncs.com/blog/css/bilibili_1.7.2_col.min.css" rel="stylesheet">
    <style>
        /* B站追番 */
        .row {
            margin: 0 10px;
    ...
    <script type="text/javascript">
        ...
        function GetMovieData(limit, page) {
            $.ajax({
                ...
                dataType: "json",
                beforeSend: function () {
                    $("#bilibiliMovie").append("<img class=\"loading_dsasd\" src=\"https://cdn.jsdelivr.net/gh/Fog-Forest/Steam-page@1.2/json/loading.svg\">");
                },
                complete: function () {
                ...
                success: function (data) {
                    ...
                    for (i = 0; i < data.data.length; i++) {
                        $("#bilibiliMovie").append("<div class=\"bangumi-item col-md-4 col-lg-3 col-sm-6\"><a class=\"no-line bangumi-link\" href=\"https://www.bilibili.com/bangumi/play/ss" + data.data[i].id + "/ \" target=\"_blank\"><div class=\"bangumi-banner\"><img class=\"lazy\" src=\"https://cdn.jsdelivr.net/gh/Fog-Forest/Steam-page@1.2/json/loading.svg\" data-src=\"" + data.data[i].image_url + "\"><div class=\"bangumi-des\"><p>" + data.data[i].evaluate + "</p></div></div><div class=\"bangumi-content\"><h3 class=\"bangumi-title\">" + data.data[i].title + "</h3></div></a></div>");
