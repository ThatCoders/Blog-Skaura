                ...
                <div class="site-top">
                    ...
                    <div class="lower-cantiner">
                        <div class="lower"><?php if (!akina_option('shownav')) { ?>
                            ...
                            <nav class="mobile-fit-control hide"><?php wp_nav_menu(array('depth' => 2, 'theme_location' => 'primary', 'container' => false)); ?></nav>
                            <!-- #site-navigation -->
                        </div>
                    </div>
                    <?php header_user_menu();
                    if (akina_option('top_search') == 'yes') { ?>
                        <div class="searchbox"><i class="iconfont js-toggle-search iconsearch icon-search"></i>
                        </div>
                    <?php } ?>
