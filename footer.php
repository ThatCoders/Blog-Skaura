        ...
        <div class="footer-device">
            <p style="font-family: 'Ubuntu', sans-serif;">
					<span style="color: #b9b9b9;">
						...
						Theme <a href="https://www.yzg.life/" target="_blank"
                                ...
                                href="https://github.com/Naive-Ghost" target="_blank"
                                style="color: #b9b9b9;;text-decoration: underline dotted rgba(0, 0, 0, .1);">Naive</a>
					</span>
            </p>
        </div>
    </div><!-- .site-info -->
    ...
    <div class="m-search">
        <form class="m-search-form" method="get" action="<?php echo home_url(); ?>" role="search">
            <input class="m-search-input" type="search" name="s"
                   placeholder="<?php _e('Search...', 'sakura') /*搜索...*/ ?>" required>
        </form>
    </div>
        ...
        <?php if (akina_option('live_search')) { ?>
            <div class="micro">
                ...
                <input id="search-input" class="text-input" type="search" name="s"
                       placeholder="<?php _e('Want to find something?', 'sakura') /*想要找点什么呢*/ ?>" required>
            </div>
